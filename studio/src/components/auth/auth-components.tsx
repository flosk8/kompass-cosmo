...
/**
 * Auth Logo Header - Kompass logo with text
 */
export const AuthLogoHeader = () => {
  return (
    <a href="https://kompass.guide" className="flex items-center gap-2 text-white">
      <KompassLogo width={48} height={48} />
      <span className="text-base font-semibold lg:text-lg">ARD Kompass</span>
    </a>
  );
};
  ...
  <div className="flex items-center gap-6">
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(165deg, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0.04) 25%, transparent 50%)',
        }}
      />
...
export const ProductCosmoStack = ({
  ...
  const signupContent = variant === 'signup' ? getSignupContent(signupVariant ?? 'default') : null;
  if (signupContent) {
