            ...
            <div className="w-full max-w-md lg:max-w-lg">
              <AuthCard className="w-full rounded-xl px-6 py-8 lg:px-10 lg:py-12">
                ...
                <div className="mt-8 lg:mt-12">
                  <h2 className="text-2xl font-normal leading-[120%] text-white lg:text-[32px]">Log in</h2>

                  <div className="mt-6 space-y-3 lg:mt-8 lg:space-y-4">
                    {/* Kompass kustomize: GitHub login disabled */}
                    {/* <Button
                      variant="outline"
                      size="lg"
                  ...
                  {/* Kompass kustomize: self-signup disabled */}
