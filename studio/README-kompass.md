...
## Build an Image
There is a GitHub Action k-studio-ci.yaml that startes the docker build process on every merge request or push to the kompass-studio branch.
...
To build and tag new release sync the main branch of this fork with the original Wundergraph Cosomo repository.
